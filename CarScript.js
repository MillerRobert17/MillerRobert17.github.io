...
function MoveCars()
{
    ...
    if (car1Left < finish && car2Left < finish && car3Left < finish) {
        ...
        if (car1Left == winner) {
            document.getElementById("message").innerText = "Car 1 Wins! Click here to Restart";
            
        } else if (car2Left == winner) {
            document.getElementById("message").innerText = "Car 2 Wins! Click here to Restart";
            
        } else if (car3Left == winner) {
            document.getElementById("message").innerText = "Car 3 Wins! Click here to Restart";
